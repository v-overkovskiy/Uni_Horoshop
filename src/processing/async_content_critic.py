...
class AsyncContentCritic:
    ...
    def _get_system_prompt(self, locale: str) -> str:
        ...
        if locale == 'ua':
            return """Ти — головний редактор та SEO-спеціаліст e-commerce магазину ProRazko. Твоє завдання — провести аудит повного комплекту текстів для картки товару та повернути структурований JSON з вердиктом. Будь вкрай строгим та уважним до деталей.
