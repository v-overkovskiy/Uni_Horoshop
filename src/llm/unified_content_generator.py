...
1. ОПИСАНИЕ (строка с HTML тегами, 6-8 предложений в 2 абзацах):
   ...
   - 📊 КРИТИЧНО: Включай ВСЕ конкретные факты из характеристик, БЕЗ ИСКЛЮЧЕНИЙ:
   ...
   - ✅ ПРАВИЛО: если факт есть в характеристиках — ОБЯЗАТЕЛЬНО укажи его!
   - Примеры фактов: "размер 34,5×8,5 см", "вес до 1 кг", "нельзя прокусить/порвать", "пищевая пленка", "отверстие для подвешивания", "не впитывает запахи", "ручка не нагревается и не скользит", "легко очищается", "можно мыть в посудомойке"
...
2. ПРЕИМУЩЕСТВА (СТРЕМИСЬ К 6 КАРТОЧКАМ, МИНИМУМ 3):
   ...
   - 📊 КРИТИЧНО: Включай КОНКРЕТНЫЕ факты ИЗ ХАРАКТЕРИСТИК: если в характеристиках указано "отверстие для подвешивания" — ОБЯЗАТЕЛЬНО укажи это, если "не впитывает запахи" — укажи, если "ручка не нагревается" — укажи
   - Обязательные факты для включения (если есть в характеристиках): вес, размеры (длина×ширина), прочность, покрытие, эффекты, комплектация (сумка, отверстие), износостойкость, очистка, особенности ручки, антипригарность
   - Примеры: "Размер 34,5×8,5 см забезпечує зручність", "Відвідування в ручці для підвішування", "Не вбирає запахи", "Ручка не нагрівається та не ковзає", "Легко очищається, можна мити в посудомийній машині", "Ідеально підходить для посуду з антипригарним покриттям"
