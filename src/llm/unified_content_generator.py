...
1. ОПИСАНИЕ (строка с HTML тегами, 6-8 предложений в 2 абзацах):
   ...
   - 📊 КРИТИЧНО: Включай ВСЕ конкретные факты из характеристик: размеры (развернутый и в сложенном виде), вес, толщина, материал (название + покрытие), прочность (нельзя прокусить/порвать), эффекты (массажный), комплектация (сумка), износостойкость, легкость очистки
   - НЕ ПРОПУСКАЙ ИМПОРТАНТЫЕ ФАКТЫ: если в характеристиках есть размер, вес, прочность — ОБЯЗАТЕЛЬНО укажи их!
   - Примеры фактов: "вес до 1 кг", "размер в сложенном виде 90×40 см", "нельзя прокусить/порвать", "пищевая пленка", "ребристая поверхность с массажным эффектом", "комплектуется сумкой", "легко очищается влажной салфеткой"
...
2. ПРЕИМУЩЕСТВА (СТРЕМИСЬ К 6 КАРТОЧКАМ, МИНИМУМ 3):
   ...
   - 📊 КРИТИЧНО: Включай КОНКРЕТНЫЕ факты из характеристик (цифры, размеры, свойства, материалы)
   - Обязательные факты для включения: вес (кг/г), размеры (в сложенном виде), прочность ("нельзя прокусить/порвать"), покрытие (пищевое/термоизоляционное), эффекты (массажный), комплектация (сумка), износостойкость, очистка
   - Примеры: "Легкий вес до 1 кг", "Компактный размер 90×40 см в сложенном виде", "Прочный материал, нельзя прокусить или порвать", "Ребристая поверхность с массажным эффектом", "Пищевая пленка на поверхности", "Комплектуется удобной сумкой для транспортировки"
