...
1. ОПИСАНИЕ (строка с HTML тегами, 6-8 предложений в 2 абзацах):
   ...
   - 📊 ВАЖНО: Обязательно включай конкретные факты из исходника (размеры, вес, материалы, свойства)
   - Примеры фактов: "вес до 1 кг", "размер в сложенном виде 90×40 см", "нельзя прокусить/порвать", "пищевая пленка", "ребристая поверхность", "массажный эффект"
...
2. ПРЕИМУЩЕСТВА (3-6 уникальных карточек):
   ...
   - 📊 ВАЖНО: Включай конкретные факты в преимущества (цифры, размеры, свойства)
   - Примеры: "Легкий вес до 1 кг", "Компактный размер 90×40 см в сложенном виде", "Прочный материал", "Массажная поверхность", "Пищевое покрытие"
