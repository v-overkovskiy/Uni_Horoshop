...
- ❗❗❗ ЕСЛИ в блоке "Дополнительные факты из текстового описания" ЕСТЬ данные — ТЫ ОБЯЗАН их использовать в описании и преимуществах!
- ❗❗❗ ЛЮБОЙ факт из "Дополнительных фактов" — это РЕАЛЬНАЯ информация о товаре, ты ДОЛЖЕН включить его в текст!
...
1. ОПИСАНИЕ (строка с HTML тегами, СТРОГО 6 предложений в 2 абзацах):
   ...
   - ❗❗❗ ОБЯЗАТЕЛЬНО: используй ВСЕ факты из блока "Дополнительные факты из текстового описания"!
   - ❗❗❗ ПРАВИЛО: если в "Дополнительных фактах" есть "Вес: до 1 кг" — УКАЖИ это в тексте! Если "Размеры: 90×40" — УКАЖИ! Если "Эффекты: массажный эффект" — УКАЖИ!
   ...
   - 📊 КРИТИЧНО: Включай ВСЕ конкретные факты из характеристик И из текстового описания, БЕЗ ИСКЛЮЧЕНИЙ:
   - ✅ ПРИОРИТЕТ #1: Все факты из блока "Дополнительные факты из текстового описания" — ОБЯЗАТЕЛЬНО использовать!
   ...
   - ✅ ПРАВИЛО: если факт есть в характеристиках ИЛИ в "Дополнительных фактах из текстового описания" — ОБЯЗАТЕЛЬНО укажи его в описании!
...
2. ПРЕИМУЩЕСТВА (СТРЕМИСЬ К 6 КАРТОЧКАМ, МИНИМУМ 3):
   - ❗❗❗ КРИТИЧЕСКИ ВАЖНО: создавай преимущества ИЗ ФАКТОВ блока "Дополнительные факты из текстового описания"!
   - ❗❗❗ ПРАВИЛО: каждое преимущество = факт из "Дополнительных фактов"!
   - ИДЕАЛЬНО: 6 уникальных преимуществ с конкретными фактами из блока "Дополнительные факты"
   - ДОПУСТИМО: 3-5, если фактов недостаточно
   - 🚫 КРИТИЧНО: ЗАПРЕЩЕНО добавлять свойства, которых нет в характеристиках ИЛИ в "Дополнительных фактах"
   - НЕ используй generic-фразы: "высокое качество", "эффективный результат"
   - Каждое преимущество должно быть уникальным и полезным
   - ✅ ПРИОРИТЕТ #1: Используй факты из блока "Дополнительные факты из текстового описания" для преимуществ!
   - 📊 КРИТИЧНО: Включай КОНКРЕТНЫЕ факты ИЗ ХАРАКТЕРИСТИК И ИЗ ТЕКСТОВОГО ОПИСАНИЯ: если в "Дополнительных фактах" указано "Вес: до 1 кг" — ОБЯЗАТЕЛЬНО создай преимущество с этим фактом! Если "Размеры: 90×40" — укажи в преимуществе! Если "Эффекты: массажный эффект" — включи!
